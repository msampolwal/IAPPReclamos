...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.iapp.reclamos.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.iapp.reclamos.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.iapp.reclamos.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.iapp.reclamos.domain.Authority.class.getName(), jcacheConfiguration);
