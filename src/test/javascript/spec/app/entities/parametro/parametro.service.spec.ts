    ...
    describe('Parametro Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/parametros';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Parametro', () => {
                service.create(new Parametro(null)).subscribe(received => {
            ...
            it('should update a Parametro', () => {
                service.update(new Parametro(123)).subscribe(received => {
