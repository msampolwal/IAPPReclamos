    ...
    describe('PedidoMySuffix Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pedidos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PedidoMySuffix', () => {
                service.create(new PedidoMySuffix(null)).subscribe(received => {
            ...
            it('should update a PedidoMySuffix', () => {
                service.update(new PedidoMySuffix(123)).subscribe(received => {
            ...
            it('should return a PedidoMySuffix', () => {
            ...
            it('should return a list of PedidoMySuffix', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PedidoMySuffix(123)]);
            });
